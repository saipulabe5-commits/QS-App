...
export const PROJECTS_TABLE_SCHEMA: DatabaseTableDefinition = {
  ...
  fields: {
    ...
    taxPercent: { type: 'number', required: true, defaultValue: 11, validationRule: '0 <= x <= 100', description: 'Persentase Pajak Pertambahan Nilai (PPN)' },
...
export const PROJECT_TEMPLATES_TABLE_SCHEMA: DatabaseTableDefinition = {
  ...
  fields: {
    ...
    defaultTax: { type: 'number', required: true, defaultValue: 11, description: 'Default PPN %' },
...
export const COMPANY_SETTINGS_TABLE_SCHEMA: DatabaseTableDefinition = {
  ...
  fields: {
    ...
    defaultTax: { type: 'number', required: true, defaultValue: 11, description: 'Persentase PPN default' },
