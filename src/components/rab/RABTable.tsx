              ...
              .map((cat, catIdx) => {
                ...
                return (
                  <React.Fragment key={cat}>
                    ...
                    <tr className="bg-slate-100/90 font-bold text-slate-900 border-y border-slate-200 hover:bg-slate-100 transition-colors">
                      ...
                      <td colSpan={5} className="px-3 py-2.5">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="uppercase tracking-wide text-xs font-extrabold text-slate-900">
                            {cat}
                          </span>
                      ...
                      <td className="px-3 py-2.5 text-right font-bold text-blue-700 font-mono text-xs">
                        {formatNumber(catWeight, 2)}%
                      </td>
                      <td colSpan={2} className="px-3 py-2.5 text-right">
                        <button
                          onClick={() => onAddItem(cat)}
                          className="text-[11px] font-bold text-blue-700 hover:text-blue-900 bg-white hover:bg-blue-50 px-2.5 py-1 rounded-lg border border-slate-300 hover:border-blue-300 transition-colors shadow-2xs inline-flex items-center space-x-1"
                        >
