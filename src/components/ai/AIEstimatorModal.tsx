  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      <motion.div
        ...
        className="relative w-full max-w-4xl rounded-[20px] shadow-[0_20px_50px_rgba(0,0,0,0.15)] overflow-hidden z-10 flex flex-col max-h-[90vh] border border-white/40 bg-[var(--bg-elevated)]/70 backdrop-blur-2xl"
      >
        {/* HEADER MAC OS STYLE */}
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-6 bg-[var(--bg-elevated)]/60 space-y-5">
          {/* Prompt input */}
          <div className="space-y-3">
            <div>
              ...
              <textarea
                ...
                className="w-full px-3.5 py-2.5 text-xs bg-[var(--bg-elevated-hover)] border border-[var(--border-primary)] rounded-xl focus:bg-[var(--bg-elevated)] focus:ring-2 focus:ring-blue-500/20 leading-relaxed"
              />
            </div>
