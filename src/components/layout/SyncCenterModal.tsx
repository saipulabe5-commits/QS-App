          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-base font-bold text-white tracking-tight">
                Pusat Sinkronisasi Offline &amp; PWA
              </h2>
              <p className="text-xs text-slate-400">
                Penyimpanan terdistribusi lokal IndexedDB dengan antrian sinkronisasi dua arah ke server.
              </p>
            </div>
          </div>
          <button
        ...
        <div className="flex-1 overflow-y-auto p-6 custom-scrollbar space-y-4">
          ...
          {conflicts.length > 0 && (
            <div className="p-4 bg-rose-50 rounded-xl border border-rose-200 space-y-3">
              ...
              {selectedConflict && (
                <div className="p-3 bg-white rounded-lg border border-rose-200 text-xs space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="p-2.5 bg-blue-50/50 rounded-lg border border-blue-200">
                      ...
                      <pre className="text-[10px] font-mono text-slate-700 max-h-24 overflow-y-auto custom-scrollbar">
                    ...
                    <div className="p-2.5 bg-slate-50 rounded-lg border border-slate-200">
                      ...
                      <button
                        ...
                        className="w-full mt-2 py-1 bg-slate-800 text-white text-[11px] font-bold rounded-md hover:bg-slate-900"
                      >
                        Gunakan Data Server
                      </button>
                    </div>
          ...
          <div>
            ...
            {queue.length === 0 ? (
              <div className="p-8 bg-slate-50 rounded-xl border border-slate-200 text-center text-xs text-slate-500">
                ...
                <p className="text-[11px] text-slate-400">Tidak ada delta perubahan lokal yang tertunda.</p>
              </div>
            ) : (
                    ...
                    <tbody className="divide-y divide-slate-100">
                      {queue.map((op) => (
                        <tr key={op.id} className="hover:bg-slate-50">
                          ...
                          <td className="p-2.5 font-semibold capitalize text-slate-700">
                            {op.operation}
                          </td>
