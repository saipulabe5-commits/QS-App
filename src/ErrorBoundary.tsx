  ...
  public render() {
    ...
    if (state && state.hasError) {
      ...
      if (props && props.isViewLevel) {
        return (
          <div className="p-8 bg-white dark:bg-slate-900 border border-rose-200 dark:border-rose-500/30 rounded-2xl shadow-sm my-4 text-center max-w-2xl mx-auto">
            <div className="w-12 h-12 bg-rose-100 dark:bg-rose-500/15 text-rose-600 rounded-2xl flex items-center justify-center mx-auto mb-4">
            ...
            <div className="bg-slate-50 dark:bg-slate-500/15 border border-slate-200 dark:border-slate-500/30 rounded-lg p-3 text-left font-mono text-xs text-slate-700 dark:text-slate-300 mb-6 overflow-x-auto max-h-32">
              <span className="text-slate-500 dark:text-slate-400">ID Insiden: {state.errorId}</span>
              <div className="mt-1 text-rose-700 dark:text-rose-300">{sanitizedMessage}</div>
            </div>
      ...
      return (
        <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-100 flex items-center justify-center p-4">
          <div className="max-w-xl w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-500/30 rounded-2xl p-6 sm:p-8 shadow-2xl">
            ...
            <div className="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-500/30 rounded-xl p-4 mb-6 font-mono text-xs text-slate-600 dark:text-slate-300 overflow-x-auto max-h-44">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <button
                ...
                className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-500/15 hover:bg-slate-700 text-slate-200 font-semibold rounded-xl text-sm flex items-center justify-center space-x-2 transition-colors border border-slate-300 dark:border-slate-500/30 cursor-pointer"
              >
